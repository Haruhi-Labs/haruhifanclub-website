...
.login-card h2 { margin: 0 0 8px; color: #1f2937; }
...
.login-form input:focus { border-color: #16a34a; box-shadow: 0 0 0 2px rgba(22, 163, 74, 0.1); }
.ui.green.block { width: 100%; }
.ui.green:disabled { opacity: 0.6; cursor: not-allowed; }
.login-msg { margin-top: 14px; color: #dc2626; font-size: 13px; }
...
.stat-item .label { font-size: 13px; color: #6b7280; margin-bottom: 8px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em; }
.stat-item .val { font-size: 32px; font-weight: 800; color: #111; line-height: 1; }

.table-card { background: #fff; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05); overflow: hidden; border: 1px solid #e5e7eb; }
.toolbar { padding: 20px 24px; border-bottom: 1px solid #f3f4f6; display: flex; justify-content: space-between; align-items: center; }
.toolbar h3 { margin: 0; font-size: 16px; font-weight: 600; color: #374151; }

.ui.small { padding: 8px 14px; font-size: 13px; border: 1px solid #e5e7eb; background: #fff; border-radius: 6px; cursor: pointer; transition: all 0.2s; }
.ui.small:hover { background: #f9fafb; border-color: #d1d5db; }
.ui.green { background: #16a34a; color: #fff; border: none; padding: 10px 20px; border-radius: 8px; cursor: pointer; font-weight: 600; white-space: nowrap; }
.ui.green:hover { background: #15803d; }
.ui.ghost { background: transparent; border: 1px solid #d1d5db; color: #4b5563; }
.ui.ghost:hover { background: #f3f4f6; }
...
.ex-title { font-weight: 600; color: #111827; margin-bottom: 4px; line-height: 1.4; font-size: 15px; }
.ex-id { font-size: 12px; color: #9ca3af; font-family: monospace; }

.cell-reason { max-width: 500px; }
.reason-text { color: #4b5563; line-height: 1.6; font-size: 13px; background: #f9fafb; padding: 8px 12px; border-radius: 6px; border: 1px solid #f3f4f6; }
.cell-nowrap { white-space: nowrap; color: #6b7280; font-size: 13px; }
