...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/reset-password', name: 'reset-password', component: ResetPasswordView, props: { site: SITE } },
    { path: '/verify-email', name: 'verify-email', component: VerifyEmailView, props: { site: SITE } },
    {
      path: '/account',
      ...
      children: [
        ...
        { path: 'profile', name: 'account-profile', component: ProfileView, props: { site: SITE, embedded: true } },
        { path: 'settings', name: 'account-settings', component: SettingsView, props: { site: SITE, embedded: true } },
      ],
    },
