      ...
      <div class="nav-container">
        ...
        <div class="nav-left">
           <div class="logo-group" @click="goHome">
              <div :class="['logo-icon-wrapper', overlay ? 'logo-icon-wrapper--overlay' : 'logo-icon-wrapper--default']">
                <!-- 图标容器 -->
                <div :class="['logo-image-container', overlay ? 'logo-image-container--overlay' : 'logo-image-container--default']">
                    <!-- 自定义图标: 请确保 public 目录下有 haruhi-logo.jpg -->
                    <img src="/haruhi-logo-192.png" alt="Logo" class="logo-image" />
                </div>
              </div>
              <span class="logo-text serif-font">凉宫春日应援团</span>
           </div>
        ...
        <div class="nav-right">
           ...
           <router-link to="/handbook" class="nav-right-link nav-right-link--no-margin" :class="overlay ? 'nav-right-link--overlay' : 'nav-right-link--default'">
              团员手册
           </router-link>

           <div :class="['nav-divider', overlay ? 'nav-divider--overlay' : 'nav-divider--default']"></div>
    ...
    <Transition name="fade">
      <div v-if="isMobileMenuOpen" class="mobile-overlay">
         ...
         <nav class="mobile-nav serif-font">
            ...
            <router-link :to="{ name: 'quiz' }" target="_blank" @click="toggleMobileMenu" class="mobile-nav-link mobile-nav-link--gray mobile-nav-link--with-icon">
               <span>凉宫入坑测试</span>
            </router-link>

            <router-link to="/handbook" @click="toggleMobileMenu" class="mobile-nav-link mobile-nav-link--gray">团员手册</router-link>
            <router-link to="/submit" @click="toggleMobileMenu" class="mobile-nav-link mobile-nav-link--gray">我要投稿</router-link>
            <router-link to="/admin" @click="toggleMobileMenu" class="mobile-nav-link mobile-nav-link--gray">管理后台</router-link>
         </nav>
...
.logo-icon-wrapper--overlay {
  background-color: #ffffff;
  color: #000000;
}

.logo-icon-wrapper--default {
  background-color: #000000;
  color: #ffffff;
}

.logo-group:hover .logo-icon-wrapper--default {
...
.logo-image-container--overlay {
  border-color: rgba(255, 255, 255, 0.3);
}

.logo-image-container--default {
  border-color: #e5e7eb;
}
