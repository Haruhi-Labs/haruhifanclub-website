...
const siteReadinessRows = [
  [
    ...
    '已完成首页阅读流切片；用 pnpm check:news:visual 验证桌面、移动和 hover。',
  ],
  [
    '@haruhi/shop',
    '商品卡 / 筛选 / 购物车 / 订单 / 后台表单',
    '交易字段真实，适合验证 header、筛选、商品卡、详情和购物车入口的完整切片。',
    '已完成前台交易流切片；用 pnpm check:shop:visual 验证首页、详情和 hover。',
  ],
  [
    '@haruhi/art',
    '作品网格 / 筛选 / 上传 / 审核 / 弹窗',
    '媒体比例和磨砂质感原本较成熟；错误接入会削弱作品主位和审核层级。',
    '暂停应用改造；下一步先建立 art visual baseline 和媒体优先视觉稿。',
  ],
  [
    '@haruhi/exam',
    '试卷 / 题目 / 批阅 / 音频 / 编辑后台',
...
const implementationSteps = [
  ...
  [
    '1',
    '内容不变',
    '应用接入不得新增规范说明、验收口号或虚构字段；业务标题、摘要、按钮和状态文案保持原语义。',
  ],
  [
    '2',
    '入口导入',
  ...
  ['7', '提交证据', 'PR 附 390/768/1280 截图、状态矩阵、a11y 检查、bridge 删除计划和回滚步骤。'],
]
...
const contentRules = [
  [
    '应用内容不变',
    '接入设计系统时不向业务页面新增规范解释、验收说明或虚构信息；内容修改必须来自产品需求本身。',
  ],
  [
    '真实对象先于装饰',
